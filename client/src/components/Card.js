...
<div className='images'>
    ...
    <img src={process.env.REACT_APP_UPLOAD_URL + item?.attributes?.Img?.data?.attributes?.url} alt="" className='imgfirst'/>
    <img src={process.env.REACT_APP_UPLOAD_URL + item?.attributes?.Img2?.data?.attributes?.url} alt=""  className='imgsecond'/> 
</div>
