...
const Products = () => {
    ...
    const {data , loading}= useFetch(`/sub-categories?filters[categories][Id][$eq]=${catId}`);
...
<input className='inputRange' type='Range' min={0} max={1000} onChange={(e)=>setMaxprice(e.target.value)} />
            ...
            <div className='filter-item'>
                <h2>Sort by</h2>
                <h5 style={{marginBottom:"10px" , color:"blue" , fontSize:"13px", fontWeight:"bold"}}>pick one of below options to show the products</h5>
                <div className='input-item'>
